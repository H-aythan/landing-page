...
const FirmaPage = () => {
  ...
  return (
        <div className="md:px-28 flex flex-wrap justify-center ">
          <h1 className="text-center text-5xl mb-20 textColor">Antezana</h1>  
          ...
          <div className="flex flex-col xl:flex-row ">
              <div className="border-2 mx-8 md:mx-0 rounded md:h-auto xl:w-2/3 flex justify-center flex-wrap py-8">
                  <h3 className="text-3xl w-full text-center mb-3 textColor">Titulo</h3>
              ...
              <div className="xl:w-1/3 border-2 pt-8 mx-8 md:mx-0">
                <h3 className="text-center text-3xl textColor">Titulo</h3>
